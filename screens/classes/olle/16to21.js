...
import {View, ScrollView, ActivityIndicator, Image, TouchableOpacity } from 'react-native';
    ...
    const sixteen2twentyone = ({route, navigation}) => {
    ...
    const getContents = async () => {
        const results = await(await fetch("http://203.253.207.111:8080/jsmith/restful/content?type=0&page=1&hcd=A0504")).json();
...
export default sixteen2twentyone;