...
const detailScreen_eng = ({ route, navigation: { navigate, push } }) => {
    const {
            ...
            return (
                <ScrollView
                    ...
                    <View
                        ...
                        <Text style={{ color: "black", fontSize: 17 }}>Information</Text>
    ...
    } else if (contents.hcnt_name === "Baengnokdam" || contents.hcnt_name === "Hallasan legend") {
        return (
            <ScrollView
                style={{
                    flex: 1,
...
export default detailScreen_eng;
